...
extern (D) auto CURL_IGNORE_DEPRECATION(T)(auto ref T statements)
{
    return statements;
}
...
alias CURLE_HTTP_POST_ERROR = CURLcode.CURLE_HTTP_POST_ERROR;
...
alias CURLE_FUNCTION_NOT_FOUND = CURLcode.CURLE_FUNCTION_NOT_FOUND;
...
alias CURLPROXY_SOCKS5_HOSTNAME = curl_proxytype.CURLPROXY_SOCKS5_HOSTNAME; /* this enum was added in 7.10 */
...
enum curl_khstat
{
    ...
    CURLKHSTAT_LAST = 5 /* not for use, only a marker for last-in-list */
}
...
alias curl_sshkeycallback = int function(
    CURL* easy,
    const(curl_khkey)* knownkey,
    const(curl_khkey)* foundkey,
    curl_khmatch,
...
enum CURLoption
{
    ...
    */
    ...
    CURLOPT_LASTENTRY = 323 /* the last unused */
}
...
alias CURLOPT_OBSOLETE40 = CURLoption.CURLOPT_OBSOLETE40;
...
alias CURLOPT_OBSOLETE72 = CURLoption.CURLOPT_OBSOLETE72;
...
alias CURLOPT_MAIL_RCPT_ALLLOWFAILS = CURLoption.CURLOPT_MAIL_RCPT_ALLLOWFAILS;
...
enum
{
    ...
    CURL_HTTP_VERSION_LAST = 32 /* *ILLEGAL* http version */
}
...
enum CURLversion
{
    ...
    CURLVERSION_LAST = 11 /* never actually use this */
}
...
/* nothing in curl is fun without the easy stuff */
