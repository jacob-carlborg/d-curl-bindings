...
alias CURLM_CALL_MULTI_PERFORM = CURLMcode.CURLM_CALL_MULTI_PERFORM;
alias CURLM_OK = CURLMcode.CURLM_OK;
alias CURLM_BAD_HANDLE = CURLMcode.CURLM_BAD_HANDLE;
alias CURLM_BAD_EASY_HANDLE = CURLMcode.CURLM_BAD_EASY_HANDLE;
alias CURLM_OUT_OF_MEMORY = CURLMcode.CURLM_OUT_OF_MEMORY;
alias CURLM_INTERNAL_ERROR = CURLMcode.CURLM_INTERNAL_ERROR;
alias CURLM_BAD_SOCKET = CURLMcode.CURLM_BAD_SOCKET;
alias CURLM_UNKNOWN_OPTION = CURLMcode.CURLM_UNKNOWN_OPTION;
alias CURLM_ADDED_ALREADY = CURLMcode.CURLM_ADDED_ALREADY;
alias CURLM_RECURSIVE_API_CALL = CURLMcode.CURLM_RECURSIVE_API_CALL;
alias CURLM_WAKEUP_FAILURE = CURLMcode.CURLM_WAKEUP_FAILURE;
alias CURLM_BAD_FUNCTION_ARGUMENT = CURLMcode.CURLM_BAD_FUNCTION_ARGUMENT;
alias CURLM_ABORTED_BY_CALLBACK = CURLMcode.CURLM_ABORTED_BY_CALLBACK;
alias CURLM_UNRECOVERABLE_POLL = CURLMcode.CURLM_UNRECOVERABLE_POLL;
alias CURLM_LAST = CURLMcode.CURLM_LAST;
...
alias CURLMSG_NONE = CURLMSG.CURLMSG_NONE;
alias CURLMSG_DONE = CURLMSG.CURLMSG_DONE;
alias CURLMSG_LAST = CURLMSG.CURLMSG_LAST;
...
enum CURLMoption
{
    ...
    CURLMOPT_LASTENTRY = 17 /* the last unused */
}

alias CURLMOPT_SOCKETFUNCTION = CURLMoption.CURLMOPT_SOCKETFUNCTION;
alias CURLMOPT_SOCKETDATA = CURLMoption.CURLMOPT_SOCKETDATA;
alias CURLMOPT_PIPELINING = CURLMoption.CURLMOPT_PIPELINING;
alias CURLMOPT_TIMERFUNCTION = CURLMoption.CURLMOPT_TIMERFUNCTION;
alias CURLMOPT_TIMERDATA = CURLMoption.CURLMOPT_TIMERDATA;
alias CURLMOPT_MAXCONNECTS = CURLMoption.CURLMOPT_MAXCONNECTS;
alias CURLMOPT_MAX_HOST_CONNECTIONS = CURLMoption.CURLMOPT_MAX_HOST_CONNECTIONS;
alias CURLMOPT_MAX_PIPELINE_LENGTH = CURLMoption.CURLMOPT_MAX_PIPELINE_LENGTH;
alias CURLMOPT_CONTENT_LENGTH_PENALTY_SIZE = CURLMoption.CURLMOPT_CONTENT_LENGTH_PENALTY_SIZE;
alias CURLMOPT_CHUNK_LENGTH_PENALTY_SIZE = CURLMoption.CURLMOPT_CHUNK_LENGTH_PENALTY_SIZE;
alias CURLMOPT_PIPELINING_SITE_BL = CURLMoption.CURLMOPT_PIPELINING_SITE_BL;
alias CURLMOPT_PIPELINING_SERVER_BL = CURLMoption.CURLMOPT_PIPELINING_SERVER_BL;
alias CURLMOPT_MAX_TOTAL_CONNECTIONS = CURLMoption.CURLMOPT_MAX_TOTAL_CONNECTIONS;
alias CURLMOPT_PUSHFUNCTION = CURLMoption.CURLMOPT_PUSHFUNCTION;
alias CURLMOPT_PUSHDATA = CURLMoption.CURLMOPT_PUSHDATA;
alias CURLMOPT_MAX_CONCURRENT_STREAMS = CURLMoption.CURLMOPT_MAX_CONCURRENT_STREAMS;
alias CURLMOPT_LASTENTRY = CURLMoption.CURLMOPT_LASTENTRY;
